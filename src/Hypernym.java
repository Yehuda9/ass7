...
public class Hypernym {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getName(), hypernym.getName()) && Objects
                .equals(getHyponymList(), hypernym.getHyponymList());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getName(), getHyponymList());
    }

    @Override
    public String toString() {
        return name + hyponymList.toString();
    }
}
